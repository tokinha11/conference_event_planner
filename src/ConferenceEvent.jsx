...
const ConferenceEvent = () => {
  ...
  const handleMealSelection = (index) => {
    ...
    if (item.selected) {
      const newNumberOfPeople = numberOfPeople;
                        ...
                        {venueItems[index].name === "Auditorium Hall (Capacity:200)" ? (
                          <>
                            <button
                              ...
                              onClick={() => handleRemoveFromCart(index)}> &ndash;
                            </button>
                          ...
                          <div className="button_container">
                            ...
                            <button
                              className={venueItems[index].quantity === 10 ? "btn-success btn-disabled" : "btn-success"}
                              onClick={() => handleAddToCart(index)}> &#43;
                            </button>
                          </div>
                        )}
                    ...
                    <div className="av_data venue_main" key={index}>
                      ...
                      <div className="button_container">
                        <button
                          ...
                          onClick={() => handleDecrementAvQuantity(index)}> &ndash;
                        </button>
                ...
                <div className="meal_selection">
                  {mealsItems.map((item, index) => (
                    <div className="meal_item" key={index} style={{ padding: 15 }}>
                      <div className="inner">
                        <input type="checkbox" className="checkbox" id={`meal$(index)`} checked={item.selected} onChange={() => handleMealSelection(index)} />
